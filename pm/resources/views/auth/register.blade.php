        ...
        <div style="position:relative;width:100%;max-width:1100px">
            ...
            <div class="floating-panel" style="position:relative;z-index:1;margin:0 auto;">
                <div class="panel-left">
                    <h2 style="margin-top:0;color:var(--blue-dark)">Create an account</h2>
                    <p class="muted">Register to start managing projects with your team.</p>
                    ...
                    <form method="POST" action="{{ route('register') }}" style="margin-top:18px;max-width:520px">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">Full name</label>
                            <input type="text" name="full_name" class="form-control" value="{{ old('full_name') }}" required style="border-radius:8px;min-height:48px;padding:12px 14px">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" name="email" class="form-control" value="{{ old('email') }}" required style="border-radius:8px;min-height:48px;padding:12px 14px">
                        </div>
                        ...
                        <div style="display:flex;justify-content:space-between;align-items:center">
                            <a href="{{ route('login') }}" class="muted">Already have an account?</a>
